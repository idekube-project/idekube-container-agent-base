...
DOC_PACKAGES="pdfplumber==0.11.9 pdfminer.six==20251230 pypdf pypdfium2==5.7.0 pikepdf==10.5.1 camelot-py==1.0.9 python-docx==1.2.0 python-pptx==1.0.2 openpyxl==3.1.5 reportlab==4.4.10 img2pdf==0.6.3"
